...
export const metadata: Metadata = {
  title: { absolute: "Legacy Homepage | OnTimer" },
  description:
    "Archived copy of the previous OnTimer homepage retained for internal reference.",
  alternates: { canonical: "https://www.ontimer.app/homepage-legacy" },
