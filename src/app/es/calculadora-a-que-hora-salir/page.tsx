    ...
    <>
      ...
      <section className="relative overflow-hidden pb-3 pt-4 sm:pb-8 sm:pt-10 md:pb-10 md:pt-14">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <h1 className="text-3xl font-black tracking-tight text-white sm:text-6xl">¿A qué hora <span className="text-green-500">debo salir?</span></h1>
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-zinc-300 sm:mt-4 sm:text-lg">Indica cuándo necesitas llegar. OnTimer calcula una hora de salida realista con el trayecto, el tráfico, el margen que prefieres y el tiempo para aparcar o entrar.</p>
        </div>
      </section>
