...
const columns = [
  ...
  { title: "Plan your time", links: [["Days Until Calculator", "/days-until"], ["Time-to-Leave Calculator", "/what-time-should-i-leave"], ["Airport Time-to-Leave Calculator", "/airport-time-to-leave-calculator"], ["Cruise Time-to-Leave Calculator", "/cruise-terminal-time-calculators"], ["Wake-Up Time Calculator", "/wake-up-time-calculator"], ["Browse all calculators", "/time-calculators"]] },
